...
import { PartyContext } from './results';
...
const PartyResults =() => {
    ...
    const partyResultContext = useContext(PartyContext);
            ...
            <div className='flex flex-col lg:flex-row gap-8'>
                <div className="flex flex-col w-full lg:w-1/2 space-y-8">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                <Pie
                                    ...
                                    outerRadius={150}
                                >
                                    {partyResultContext.map((entry, index) => (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {partyResultContext.map((party, index) => (
                        ...
                        <div key={index} className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-lg">
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4">
                                <div
                                    ...
                                    style={{ width: `${(party.numOfVotes / Math.max(...partyResultContext.map(p => p.numOfVotes))) * 100}%` }}
                                ></div>
                            </div>
